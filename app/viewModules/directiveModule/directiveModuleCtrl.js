define(['angular'], function(angular) {
    return function(app, elem, attrs, scope) {
        ...
        app.controller('directiveModuleCtrl', ['$scope', '$cookies', '$location', '$state', 'directiveModuleService', 'G', '$timeout', '$window', '$sce','$compile', '$rootScope', function($scope, $cookies, $location, $state, service, G, $timeout, $window, $sce, $compile, $rootScope) {
            $scope.data = [];
